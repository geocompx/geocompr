...
Of note is **mapsf**, which generates a range cartographic visualizations including choropleth, 'proportional symbol' and 'flow' maps, each of which is documented in the package's [`mapsf`](https://cran.r-project.org/web/packages/mapsf/vignettes/mapsf.html) vignette \index{mapsf (package)}.
