...
However, a decade later static plotting was still the emphasis of geographic data visualisation in R [@cheshire_spatial_2015].
...
```{r 08-mapping-34, eval=FALSE, echo=FALSE}
