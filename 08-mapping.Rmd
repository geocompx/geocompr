...
This has changed with the emergence of open source mapping software such as the R package **tmap** and the 'print composer' in QGIS which enable anyone to make high quality maps, enabling 'citizen science'.
...
```{r na-sb, message=FALSE, fig.cap="Map with additional elements - a north arrow and scale bar.", fig.scap="Map with a north arrow and scale bar.", fig.asp=1}
map_nz + 
...
```{r tmstyles, message=FALSE, fig.cap="Selected tmap styles: bw, classic, cobalt and col_blind (from left to right).", fig.scap="Selected tmap styles: bw, classic, cobalt and col_blind.", echo=FALSE, fig.asp=0.56}
...
```{r urban-facet, message=FALSE, fig.cap="Faceted map showing the top 30 largest 'urban agglomerations' from 1970 to 2030 based on population projects by the United Nations.", fig.scap="Faceted map showing urban agglomerations.", fig.asp=0.5}
...
```{r animus, echo=FALSE, message=FALSE, fig.cap="Animated map showing population growth and state formation and boundary changes in the United States, 1790-2010. Animated version available online at geocompr.robinlovelace.net.", fig.scap="Animated map showing boundary changes in the United States."}
...
```{r leaflet, message=FALSE, fig.cap="The leaflet package in action, showing cycle hire points in London.", fig.scap="The leaflet package in action."}
...
```{r coffeeApp, echo=FALSE, message=FALSE, fig.cap="coffeeApp, a simple web mapping application for exploring global coffee production in 2016 and 2017. Interactive version available online at geocompr.robinlovelace.net.", fig.scap="coffeeApp, a simple web mapping application."}
...
```{r cartomap2, echo=FALSE, message=FALSE, fig.cap="Comparison of non-continuous area cartogram (top) and Dorling cartogram (bottom).", fig.scap="Comparison of cartograms.", fig.asp=0.32}
