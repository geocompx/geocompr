...
```{r CycleHireApp-html, echo=FALSE, fig.cap="Hire a cycle App, message=FALSE," a simple web mapping application for finding the closest cycle hiring station based on your location and requirement of cycles. Interactive version available online at geocompr.robinlovelace.net.", fig.scap="Cycle Hire App, a simple web mapping application.", eval=knitr::is_html_output()}

#knitr::include_app("https://shiny.robinlovelace.net/coffeeApp/")
#would require hosting of cycle hire app

library(pacman)
p_load(sf, shiny, spData, leaflet, tidyverse, spDataLarge, units, leaflet.extras)
