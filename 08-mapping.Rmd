...
```{r mapdeck, engine='zsh', echo=FALSE, eval=FALSE}
...
```{r, echo=FALSE, fig.cap="Map generated by mapdeck, representing road traffic casualties across the UK. Height of 1 km cells represents number of crashes."}
