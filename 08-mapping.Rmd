...
```{r tmcol, message=FALSE, fig.cap="Comparison of base (left) and tmap (right) handling of a numeric color field.", echo=FALSE, out.width="50%", fig.show='hold', warning=FALSE, message=FALSE}
plot(nz["Land_area"])    
tm_shape(nz) + tm_fill(col = "Land_area")
```
...
```{r tmpal, message=FALSE, fig.cap="Illustration of settings that affect color settings. The results show (from left to right): default settings, manual breaks, n breaks, and the impact of changing the palette.", echo=FALSE}
...
```{r colpal, echo=FALSE, message=FALSE, fig.cap="Examples of categorical, sequential and diverging palettes.", out.width="40%"}
...
```{r na-sb, message=FALSE, fig.cap="Map with additional elements - a north arrow and scale bar."}
map_nz + 
...
```{r layout1, message=FALSE, fig.cap="Layout options specified by (from left to right) title, scale, bg.color and frame arguments.", echo=FALSE}
...
```{r layout2, message=FALSE, fig.cap="Illustration of selected layout options.", echo=FALSE}
...
```{r layout3, message=FALSE, fig.cap="Illustration of selected color-related layout options.", echo=FALSE}
...
```{r tmstyles, message=FALSE, fig.cap="Selected tmap styles: bw, classic, cobalt and col_blind (from left to right).", echo=FALSE}
...
```{r urban-facet, message=FALSE, fig.cap="Faceted map showing the top 30 largest 'urban agglomerations' from 1970 to 2030 based on population projects by the United Nations.", fig.asp=0.4}
...
```{r cartomap2, echo=FALSE, message=FALSE, fig.cap="Comparison of non-continuous area cartogram (top) and Dorling cartogram (bottom)."}
