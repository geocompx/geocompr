...
```{r urban-facet, message=FALSE, fig.cap="Faceted map showing the top 30 largest 'urban agglomerations' from 1970 to 2030 based on population projects by the United Nations.", fig.scap="Faceted map showing the top 30 largest 'urban agglomerations'.", fig.asp=0.5}
...
```{r cartomap2, echo=FALSE, message=FALSE, fig.cap="Comparison of non-continuous area cartogram (top) and Dorling cartogram (bottom).", fig.scap="Comparison of non-continuous area cartogram and Dorling cartogram.", fig.asp=0.32}
