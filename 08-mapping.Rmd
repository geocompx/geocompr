...
This allows web mapping applications to be represented in a single file, such as the [`coffeeApp/app.R`](https://github.com/Robinlovelace/geocompr/blob/master/apps/coffeeApp/app.R) file in the book's GitHub repo.
...
The recommended next step is to open the previously mentioned [`CycleHireApp/app.R`](https://github.com/Robinlovelace/geocompr/blob/master/apps/CycleHireApp/app.R) script in an IDE of choice, modify it and re-run it repeatedly.
