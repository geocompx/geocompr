...
if (knitr::is_latex_output()){
    ...
    # file.copy("tmview-1.html", "figures/tmview-1.html")
    htmltools::includeHTML("figures/tmview-1.html")
}
...
```{r leaflet, message=FALSE, fig.cap="The leaflet package in action, showing cycle hire points in London.", fig.scap="The leaflet package in action.", echo=FALSE}
if (knitr::is_latex_output()){
...
```{r coffeeApp-html, echo=FALSE, message=FALSE, fig.cap="coffeeApp, a simple web mapping application for exploring global coffee production in 2016 and 2017. Interactive version available online at geocompr.robinlovelace.net.", fig.scap="coffeeApp, a simple web mapping application.", eval=knitr::is_html_output()}
knitr::include_app("https://bookdown.org/robinlovelace/coffeeapp/")
```

```{r coffeeApp-latex, echo=FALSE, message=FALSE, fig.cap="coffeeApp, a simple web mapping application for exploring global coffee production in 2016 and 2017. Interactive version available online at geocompr.robinlovelace.net.", fig.scap="coffeeApp, a simple web mapping application.", eval=knitr::is_latex_output()}
knitr::include_graphics("figures/coffeeApp-1.png")
```
