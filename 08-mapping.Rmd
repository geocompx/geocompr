...
```{r urban-animated, message=FALSE, fig.cap="Animated map showing the top 30 largest 'urban agglomerations' from 1950 to 2030 based on population projects by the United Nations.", echo=FALSE}
...
```{r animus, echo=FALSE, message=FALSE, fig.cap="Animated map showing population growth and state formation and boundary changes in the United States, 1790-2010."}
...
```{r tmview, message=FALSE, fig.cap="Interactive map of New Zealand created with tmap in view mode.", echo=FALSE}
tmap_mode("view")
m_tmview = map_nz
...
```{r coffeeApp, echo=FALSE, message=FALSE, fig.cap="coffeeApp, a simple web mapping application for exploring global coffee production in 2016 and 2017."}
