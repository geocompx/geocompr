...
The most important recent evolution in R's spatial ecosystem has been without doubt support for simple features thanks to the **sf** package [@R-sf], described in Chapter \@ref(spatial-class).
