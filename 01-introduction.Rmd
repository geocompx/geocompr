...
A robust geometry engine to R was added as a part of Google Summer of Code 2010 with creation of the **rgeos** package.
...
In the latter years, two new packages were published after the release of new GRASS GIS versions: **spgrass6** for GRASS GIS 6 and **rgrass7** for GRASS GIS 7.
...
**ggplot2** spatial capabilities were improved in 2011 with the release of its associated package - **ggmap**, which provided several tools for spatial data visualization.
...
The **tmap** package was released in 2014 and enabled creation of thematic maps. 
<!-- ADD THIS LATTER -->
