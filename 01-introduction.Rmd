...
This book exists at the intersection between two vast subjects, Geography and R (Figure \@ref(fig:venn)): its original title was *Geography with R*.
The emphasis in this book, as in the seminal *Applied Spatial Data Analysis with R* (ASDAR) [@bivand_applied_2013], is on handling geographic data with R or using R as a *Geographic Information System* (GIS).
However, we wanted to convey the message that it's not just about spatial data, as non-spatial 'attribute data' are inevitably bound-up in datasets that contain coodinates.
One of the great advantages of using R for geographical data analysis is that you can switch seamlessly between the geographical and non-geographical elements of your data, an idea not well-captured by the term GIS but implicit in the Geography.

We opted for the title *Geocomputation with R* because the book is about doing geographical operations on a computer but also much more than that.
In the words of @longley_geocomputation:_1998 "what is distinctive about geocomputation is the creative and experimental use of GIS that it entails".
Geocomputation is a relatively young field, with a ~30 year history dating back to the first [conference](http://www.geocomputation.org/) on the subject, held in Leeds in 1996, and a flurry of subsequent publications including @longley_geocomputation:_1998.
It's worth remembering, however, that the topic is part of the wider field of Geography which has over 2000 years worth of history [@roller_eratosthenes_2010].
