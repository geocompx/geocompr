...
However, R has advantages that make it a good language for learning geocomputation and for many geocomputation tasks, especially in relation to statistics, modelling and visualization.
...
## Why open source and reproducible tools for geocomputation?
