...
For instance, an autonomous car is believed to create one terabyte of data on a daily base.
...
This also includes advanced geostatistical and spatial modeling as well as geocomputation and mapping.^[[RStudio](https://www.rstudio.com/) greatly facilitates the usage of this rich programming suite as well as the development of software and code in R.
...
Though we will almost exclusively use R for geocomputation throughout this book, there are of course other software packages available for geocomputation.
...
However, its main purpose was the easy access of several APIs to automatically download map tiles (among others, Google Maps, OpenStreetmap) and subsequent plotting of these as a basemap. 
