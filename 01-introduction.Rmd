...
By the year 2000, there were already R packages for performing various tasks, including "point pattern analysis, geostatistics, exploratory spatial data analysis and spatial econometrics", as described in an article on presented at the GeoComputation2000 conference [@bivand_open_2000].
