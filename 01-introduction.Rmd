...
It's about trying to make research which involves geographic data more reproducible and therefore scientific, a concept captured by the term Geographic Data Science.
...
<!-- Idea: add table comparing GIS with GDSL -->
