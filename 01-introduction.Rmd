...
R is not the only language providing CLIs for computation.
A range of interactive notebooks and integrated development environments enable powerful and reproducible workflows for geocomputation in other languages, such as Python, Julia, and JavaScript.
Many of the techniques taught in this book can be undertaken in other languages, and we encourage curious readers to give them a try, perhaps with reference to the book Geocomputation with Python.
