...
However, a demand for convinient methods for spatial data visualisations rose with an increase in R spatial possibilities. 
...
They could be generated based on the spatial objects and its layout is optimed for maps with the use of legends, scale bars, grid lines, north arrows, etc.
...
Additionaly, the **mapview** package was created on top of **leaflet**. <!--CITE-->
It enabled quick creation of interactive visualization of spatial data containing variety of backgroud maps, dynamic scale bar, feature attributes viewer and more.
