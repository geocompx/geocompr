...
```{r revdep, echo=FALSE}
top_dls = read.csv("extdata/top_dls.csv")
cap = paste0("The top 5 most downloaded packages that depend on sf. As of ", Sys.Date(), " there are ", nrow(top_dls), " packages which import sf.")
knitr::kable(top_dls[1:5,], digits = 0, caption = cap)
...
```{r cranlogs, fig.cap="The popularity of spatial packages in R. The y axis shows the average number of downloads, within a 30 day rolling window, of R's top 5 spatial packages, defined as those with the highest number of downloads within the last 30 days."}
