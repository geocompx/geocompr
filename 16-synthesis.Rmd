...
This decision is justified by the fact (that aside from large-scale fine-resolution remote sensing data) the majority of geographic datasets that are needed for common research or policy applications *do* fit on consumer hardware.
