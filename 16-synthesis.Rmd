...
This decision is justified by the fact (that aside from large-scale fine-resolution remote sensing data; for a short introduction, please refer to subsection \@ref(cloud)) the majority of geographic datasets that are needed for common research or policy applications *do* fit on consumer hardware.
