...
**tmap** allows a wide variety of layout settings to be changed, some of which are illustrated in Figure \@ref(fig:layout1) which was produced using the following code (see `args(tm_layout)` or `?tm_layout` for a full list):
