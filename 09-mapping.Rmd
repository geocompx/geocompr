...
map_nz + tm_layout(aes.color = c(fill = "red"))
map_nz + tm_layout(attr.color = "red")
map_nz + tm_layout(sepia.intensity = 0.9)
map_nz + tm_layout(aes.color = c(fill = "red"), saturation = 0.5)
```
