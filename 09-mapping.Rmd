...
```{r tmlayers, fig.cap="Maps with additional layers added to the final map of Figure 9.1.", warning=FALSE}
...
```{r break-styles, fig.cap="Illustration of different binning methods set using the style argument in tmap.", echo=FALSE, warning=FALSE}
