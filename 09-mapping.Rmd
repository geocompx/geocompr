...
trails |>
  ...
  mapview(franconia, zcol = "district", burst = FALSE) +
  breweries
```
...
terra::plot(nz_elev / 1000, add = TRUE)
...
We have covered mapping with **sf**, **terra** and **ggplot2** packages first because these packages are highly flexible, allowing for the creation of a wide range of static maps.
