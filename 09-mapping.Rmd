...
Categorical palettes are used for categorical data without any order, for example names of states or land cover categories.
<!-- distinguish colors -->
<!-- related to true features/previous maps -->
<!-- sequential -->
<!-- diverging -->
