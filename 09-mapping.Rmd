...
Usually, lower values are presented by the light colors and darker colors indicate larger values.
<!-- diverging -->
...
```{r layout2, fig.cap="Illustration of selected color-related layout options.", echo=FALSE}
