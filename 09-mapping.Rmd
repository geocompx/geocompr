...
It expects a vector of colors or a new color palette name, which can be selected interactively with `cols4all::c4a_gui()`.
...
<!--toDo:jn-->
<!--expand-->
Additional, fourth group of color palettes, bivariate, also exist.
