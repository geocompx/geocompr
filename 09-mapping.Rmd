...
The legend position (and also the position of several other map elements in **tmap**) can be customized using one of few functions.
...
Alternatively, we may provide two numbers between 0 and 1 here
