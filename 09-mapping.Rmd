...
carto_map1 = tm_shape(us_states2163) + tm_polygons("total_pop_15")
carto_map2 = tm_shape(us_states_carto) + tm_polygons("total_pop_15")
...
carto_map3 = tm_shape(nz) + tm_polygons("Median_income")
carto_map4 = tm_shape(nz) + tm_borders() + 
  tm_shape(nz_nccarto) + tm_polygons("Median_income")
