...
map_pkgs_df = dplyr::select(pkg_df, package, title, published, dl_last_month, has_vignette = has_vignette_build, contributors)
knitr::kable(map_pkgs_df, caption = "Selected mapping packages, with associated metrics. 'Published' refers to the date of the last release on CRAN'.")
```
