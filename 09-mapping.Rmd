...
hex_cells = calculate_grid(africa_sp, grid_type = "hexagonal", seed = 25, learning_rate = 0.03)
africa_hex = st_as_sf(assign_polygons(africa_sp, hex_cells))

reg_cells = calculate_grid(africa_sp, grid_type = "regular", seed = 25, learning_rate = 0.03)
africa_reg = st_as_sf(assign_polygons(africa_sp, reg_cells))

tgg1 = tm_shape(africa_sp) + tm_polygons("pop_growth", title = "Population growth (annual %)")
tgg2 = tm_shape(africa_hex) + tm_polygons("pop_growth", title = "Population growth (annual %)")
tgg3 = tm_shape(africa_reg) + tm_polygons("pop_growth", title = "Population growth (annual %)")
