...
The basic maps in section \@ref(basic-map) were straightforward to produce but elaborating maps for others is an advanced topic.
...
We learned how the generic `plot()` function works with common spatial object classes in section \@ref(basic-map).
