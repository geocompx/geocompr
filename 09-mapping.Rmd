...
```{r urban-facet, fig.cap="Faceted map showing the top 30 largest 'urban agglomerations' from 1950 to 2030 based on population projects by the United Nations.", fig.asp=0.2}
...
nz_height_map = tm_shape(nz_elev, bbox = tmaptools::bb(nz_region)) +
  tm_raster(style = "cont", palette = "-Spectral", auto.palette.mapping = FALSE) +
  tm_shape(nz_height) +
  tm_symbols(shape = 2, col = "red", size = 0.1)
```
