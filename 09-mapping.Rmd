...
Layers are added to represent `nz` visually, with `tm_fill()` and `tm_borders()` representing New Zealand using shaded areas (right panel) and border outlines (middle panel) in Figure \@ref(fig:tmshape), respectively.
