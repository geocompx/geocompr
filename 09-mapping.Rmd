...
map_nza + tm_layout(aes.color = c(fill = "red"))
map_nza + tm_layout(attr.color = "red")
map_nza + tm_layout(sepia.intensity = 0.9)
map_nza + tm_layout(aes.color = c(fill = "red"), saturation = 0.5)
```
...
map_nza + tm_style_albatross() + tm_layout("tm_style_albatross")
map_nza + tm_style_cobalt() + tm_layout("tm_style_cobalt")
map_nza + tm_style_col_blind() + tm_layout("tm_style_col_blind")
map_nza + tm_style_grey() + tm_layout("tm_style_grey")
map_nza + tm_style_natural() + tm_layout("tm_style_natural")
map_nza + tm_style_white() + tm_layout("tm_style_white")
```
