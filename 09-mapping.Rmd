...
Before we cover mapping packages for plotting a specific type of map (in the next paragraph), it is worth considering alternatives to the packages already covered for general-purpose static mapping (Table \@ref(tab:map-gpkg)).
...
The code chunk below demonstrates creation of a non-contiguous area cartogram of United States of America states' population (the right-hand panel of \@ref(fig:cartomap2)). 
...
```{r cartomap2, echo=FALSE, fig.cap="Comparison of regular map (left) and non-continuous area cartogram (right)."}
carto_map3 = tm_shape(us_states2163) + 
  tm_polygons("total_pop_15", title = "Total population", palette = "BuPu")
carto_map4 = tm_shape(us_states2163) + tm_borders() + 
  tm_shape(us_states2163_nzcarto) + 
  tm_polygons("total_pop_15", title = "Total population", palette = "BuPu")
tmap_arrange(carto_map3, carto_map4)
```
