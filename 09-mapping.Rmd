...
A viewport from the **grid** packag can be used by stating a center location (`x` and `y`) and a size (`width` and `height`) of the inset map.
...
<!-- inset map -->
1. Using the `spData::world` dataset subset areas that belong to France. 
Next, create an inset map of the new object.