...
carto_map1 = tm_shape(nz) + tm_polygons("Median_income")
carto_map2 = tm_shape(nz_carto) + tm_polygons("Median_income")
...
carto_map3 = tm_shape(us_states2163) + tm_polygons("total_pop_15")
