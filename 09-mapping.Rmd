...
What we didn't mention in those sections was that plot methods for raster and vector objects can be used in combination, as illustrated in the subsequent code chunk which generates Figure \@ref(fig:nz-base).
