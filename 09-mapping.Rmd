...
Avoid too many categories: this large legends can make maps uninterpretable.^[The `col = "MAP_COLORS"` argument can be used in situations with a large number of unique object (for example a map of individual countries).]
