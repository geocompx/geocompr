...
(vailable `style`s are in fact pre-defined by `classInt::classIntervals()` --- see the help page of this function for details.
...
<!-- sth. wrong with the next sentence -->
 variable are represented by a color palette.
