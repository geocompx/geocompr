...
```{r tmshape, fig.cap="New Zealand's shape plotted with fill (left), border (middle) and fill *and* border (right) layers added using **tmap** functions.", out.width="30%", fig.show='hold'}
library(tmap)
