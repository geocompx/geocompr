...
# Bonus
zion_points_buf_2 = exactextractr::exact_extract(x = srtm, 
                                         y = zion_buffer)
# Make output similar to terra::extract() 
zion_points_buf_2 = lapply(seq_along(zion_points_buf_2), \(i) cbind(ID = i,
                                                                    zion_points_buf_2[[i]]))


zion_points_buf_2 = do.call(rbind, zion_points_buf_2) 
zion_points_buf_2 = rename(zion_points_buf_2, srtm = value)

plot(zion_points_points$srtm, zion_points_buf_2$srtm2)
```
