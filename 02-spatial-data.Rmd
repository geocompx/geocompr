...
source("https://github.com/Robinlovelace/geocompr/raw/main/code/02-raster-intro-plot.R")
```
...
```{block2 02-spatial-data-50a, type='rmdnote'}
<!--jn:toDo-->
<!--a few sentences about other types of rasters-->
```
...
new_raster2 = rast(nrows = 6, ncols = 6, resolution = 0.5, 
...
crs(new_raster3) = "EPSG:26912" # set CRS
```
