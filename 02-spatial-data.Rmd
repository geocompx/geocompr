...
```{r point, echo=FALSE, out.width="30%"}
par(pty = "s")
...
```{r linestring, echo=FALSE, out.width="30%"}
par(pty = "s")
...
```{r polygon, echo=FALSE, out.width="30%"}
par(pty = "s")
...
```{r polygon_hole, echo=FALSE, out.width="30%"}
par(pty = "s")
...
```{r geom_collection, echo=FALSE, out.width="30%"}
par(pty = "s")
