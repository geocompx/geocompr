...
<!-- Both uses of raster datasets are illustrated in Figure \@ref(fig:raster-intro-plot2). -->
...
```{r raster-intro-plot2, echo=FALSE, fig.cap="Examples of continuous and categorical rasters.", warning=FALSE, message=FALSE, eval=FALSE}
