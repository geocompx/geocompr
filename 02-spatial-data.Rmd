...
```{r raster-intro-plot, echo = FALSE, fig.cap = "Raster data types (cell IDs, cell values, a colored raster map, from left to right).", fig.scap="Raster data types."}
...
```{r raster-intro-plot2, echo=FALSE, fig.cap="Examples of continuous (left) and categorical (right) rasters."}
