...
```{r sf-ogc, fig.cap="The subset of the Simple Features class hierarchy, based on the Open Geospatial Consortium's document 06-103r4 (see http://www.opengeospatial.org/standards/sfa)", out.width="100%", echo=FALSE}
