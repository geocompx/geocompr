...
The examples above show the print methods that come with the **sf** library, demonstrating the underlying structures of the objects.
Loading **sf** and creating the `sfg_POLYGON` again results in an object printed as a regular **sf** object:
