...
We will start by creating the simplest possible `sfg` object starting with a single coordinate pair, assigned to a vector names `v`:
...
The example above shows the print methods that come with the **sfheaders** package, when **sf** is not loaded, demonstrating the underlying structures of the objects.
