...
plot(st_as_sfc("POLYGON((1 5, 2 2, 4 1, 4 4, 1 5))"), axes = TRUE, main = "POLYGON")
```

- One hole - `POLYGON ((1 5, 4 4, 4 1, 2 2, 1 5), (2 4, 3 4, 3 3, 2 3, 2 4))`

```{r polygon_hole, echo=FALSE}
plot(st_as_sfc("POLYGON((1 5, 2 2, 4 1, 4 4, 1 5), (2 4, 3 4, 3 3, 2 3, 2 4))"), col=1, axes = TRUE, main = "POLYGON with a hole")
```
...
plot(st_as_sfc("MULTIPOLYGON (((1 5, 2 2, 4 1, 4 4, 1 5), (0 2, 0 3, 1 3, 1 2, 0 2)))"), col=1, axes = TRUE, main = "MULTIPOLYGON")
par(mfrow = c(1, 1))
```
...
<!-- plots can be made -->
<!-- In most cases, the `sfc` object contains objects of identical type. -->
