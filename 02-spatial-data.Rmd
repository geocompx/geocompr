...
Other than searching for EPSG codes on-line, another quick way to find-out about available CRSs is via the `st_proj_info()` function, which outputs a data frame of available projections.
