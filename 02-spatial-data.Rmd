...
-  X and Y coordinates represent the location points in 2D space, with units depending on the coordinate reference system (CRS) of the geometry data.
Commonly used units include easting and northing in meters or longitude and latitude (see Chapter 6).
- Additionally, a Z coordinate might denote altitude but be aware of the fact that this representation is only a crude 3D-approximation since you only have one altitude value for one point.
