...
```{r sfvig2, eval=FALSE, echo=FALSE}
vignette("sf1") # an introduction to the package
...
```{block2 02-spatial-data-8, type='rmdnote'}
...
```{r 02-spatial-data-10, eval=FALSE}
library(sp)
...
```{r 02-spatial-data-11, eval=FALSE}
...
```{r 02-spatial-data-12, warning=FALSE}
...
```{r 02-spatial-data-13, echo=FALSE, eval=FALSE}
# aim: show main
...
```{r 02-spatial-data-14, eval=FALSE}
...
```{r 02-spatial-data-15, eval=FALSE}
...
```{r 02-spatial-data-22, eval=FALSE}
## GEOMETRYCOLLECTION
...
```{r 02-spatial-data-29, eval=FALSE}
...
```{block2 02-spatial-data-30, type='rmdnote'}
...
```{r 02-spatial-data-32, eval=FALSE}
lnd_sf
...
```{r 02-spatial-data-34, eval=FALSE, echo=FALSE}
...
```{r raster-intro-plot2, echo=FALSE, fig.cap="Examples of continuous and categorical rasters."}
...
```{r 02-spatial-data-35, message=FALSE}
...
```{r 02-spatial-data-36, eval=FALSE}
new_raster
#> class       : RasterLayer 
...
```{r 02-spatial-data-41, eval=FALSE}
...
```{r 02-spatial-data-42, eval=FALSE}
...
```{r 02-spatial-data-47, eval=FALSE}
...
```{block2 02-spatial-data-48, type='rmdnote'}
...
```{r 02-spatial-data-50, message=FALSE, results='hide'}
vector_filepath = system.file("vector/zion.gpkg", package = "spDataLarge")
new_vector = st_read(vector_filepath)
```
...
```{r 02-spatial-data-60, warning=FALSE, message=FALSE}
