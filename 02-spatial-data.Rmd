...
```{r sf-ogc, fig.cap="Simple feature types fully supported by sf.", out.width="100%", echo=FALSE}
...
```{r sfcs2, echo=FALSE, fig.cap="Illustration of point, linestring and polygon geometries.", out.width='33%'}
par(mfrow = c(1, 3), pty = "s", mar = c(0, 0, 0, 0)) # 아래 왼쪽, 위, 오른쪽 
plot(st_as_sfc(c("POINT(5 2)")), axes = TRUE, main = "POINT")
plot(st_as_sfc("LINESTRING(1 5, 4 4, 4 1, 2 2, 3 2)"), axes = TRUE, main = "LINESTRING")
plot(st_as_sfc("POLYGON((1 5, 2 2, 4 1, 4 4, 1 5))"), col="gray", axes = TRUE, main = "POLYGON")
#par(old_par)
...
```{r sfcs3, echo=FALSE, fig.cap="Illustration of point, linestring and polygon geometries.", out.width='33%'}
par(mfrow = c(1, 3), pty = "s", mar = c(0, 3, 1, 0)) # 아래 왼쪽, 위, 오른쪽 
plot(st_as_sfc(c("POINT(5 2)")), axes = TRUE, main = "POINT")
plot(st_as_sfc("LINESTRING(1 5, 4 4, 4 1, 2 2, 3 2)"), axes = TRUE, main = "LINESTRING")
plot(st_as_sfc("POLYGON((1 5, 2 2, 4 1, 4 4, 1 5))"), col="gray", axes = TRUE, main = "POLYGON")
#par(old_par)
...
```{r sfcs4, echo=FALSE, fig.cap="Illustration of point, linestring and polygon geometries.", out.width='99%'}
par(mfrow = c(1, 3), pty = "s", mar = c(0, 3, 1, 0)) # 아래 왼쪽, 위, 오른쪽 
# "s" meaning square
plot(st_as_sfc(c("POINT(5 2)")), axes = TRUE, main = "POINT")
plot(st_as_sfc("LINESTRING(1 5, 4 4, 4 1, 2 2, 3 2)"), axes = TRUE, main = "LINESTRING")
