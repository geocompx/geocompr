...
To re-iterate the message from Chapter \@ref(intro), geographic R packages have a long history of interfacing with lower level libraries, and **sf** continues this tradition with a unified interface to recent versions of GEOS for geometry operations, the GDAL library for reading and writing geographic data files, and the PROJ library for representing and transforming projected coordinate reference systems.
...
```{r geomcollection, echo=FALSE, fig.asp=1, fig.cap="Illustration of a geometry collection.", out.width="60%"}
...
tm1 = tm_shape(india_buffer_with_s2) +
  ...
  tm_title("s2 switched on (default)", position = tm_pos_in(), size = 1)
...
tm2 = tm_shape(india_buffer_without_s2) +
  ...
  tm_fill(fill = "grey95") +
  tm_title(" ") +
  tm_title("s2 switched off", position = tm_pos_in(), size = 1)
