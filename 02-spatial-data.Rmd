...
```{r geomcollection, echo=FALSE, out.height="3.708in", fig.cap="Illustration of geometry collection."}
# Plotted - it is referenced in ch5 (st_cast)
old_par = par(pty = "s", mar = c(0, 3, 1, 0))
...
```{r vector-crs, echo=FALSE, fig.cap="Examples of geographic (WGS 84; left) and projected (NAD83 / UTM zone 12N; right) and coordinate systems for a vector data type.", message=FALSE}
...
```{r raster-crs, echo=FALSE, fig.cap="Examples of geographic (WGS 84; left) and projected (NAD83 / UTM zone 12N; right) and coordinate systems for a raster data type.", message=FALSE}
