...
<!-- ellipsoidal model -->
The shape of an ellipse could defined by either the equatorial radius (a) and the polar radius (b), or by a and the inverse falttening (rf), where:
$$rf = 1/((a-b)/a)$$
<!--fig?-->
...
In local datums, the ellipsoid surface alings closely to the earth surface at a particular location.
