...
Access them by just typing the name of the object: 
...
Unlike the **sf** package, **raster** only uses the `proj4string` representation of the coordinate reference system.
