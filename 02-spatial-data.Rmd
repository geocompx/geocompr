...
As we have seen above, setting raster values corresponds to a rowwise cell filling starting at the upper left corner.
...
However, so far the **units** package only supports vector data.
This means, that people working on raster data have to carefully keep track of unit changes.
