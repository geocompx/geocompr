...
generally have a high level of precision (but not necessarily accuracy) characteristic, and the reason for their name, is that each point is defined by a vector: 

essentially points that can be joined up in geogr which have precise coodinat
