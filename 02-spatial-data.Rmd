...
After you have set-up a place to save your work start running/editing/testing code using an integrated development environment (IDE) such as RStudio (recommended for most people, especially beginners) or [VS Code](https://github.com/REditorSupport/vscode-R)).
