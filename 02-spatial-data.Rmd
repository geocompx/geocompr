...
After testing your up-to-date R/RStudio set-up, the next step is to load the following packages, used in this chapter (these must be installed and should be up-to-date):
