...
The work here provides a taste of the way how **sf** operates but there is much more to learn (see Chapter \@ref(spatial-data-operations)).
There is a wealth of information in the highly recommended vignettes of the package.
...
<!-- Maybe rephrase. I was instantly thinking of an actual spatial overlay (`over`) but you mereley refer to a map overlay. -->
