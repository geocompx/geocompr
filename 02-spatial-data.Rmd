...
```{r africa, out.width="50%", fig.cap="Centroids representing country population, diameter being proportional to population.", warning=FALSE}
...
## Simple feature geometries, collections and data frames
