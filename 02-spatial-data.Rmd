...
These two classes differ in terms of a number of suported files, type of representation and processing speed.

A `RasterBrick` contain multiple layers of raster data, which refer to only a single, mutlilayer file (such as mulitspectral satellite images).
