...
The same point could also be represented in a projected with 'Easting/Northing' values of `c(532e3, 180e3)`, meaning London is located is 532 km *East* and 180 km *North* of the $origin$, as illustrated in the right of Figure \@ref(vectorplots).
In the projected CRS 'EPSG:27700' used for this plot, the origin is at -2° East of the Prime Meridian and and 49° North of the Equator (see chapter \@ref(transform) for a definition of EPSG and more on CRSs).
