...
-->
Raster maps usually represent continous phenomena such as elevation, temperature, population density or spectral data (\@ref(fig:raster-intro-plot):D).
Of course, we can represent discrete features such as soil or landcover classes also with the help of a raster data model.
