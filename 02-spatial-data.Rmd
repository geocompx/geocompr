...
To generate use the command `c()` (think of 'c' for 'combine') or `seq()` (short for 'sequence') to create vectors, as illustrated below in which the point illustrated in mathematical notation is created:
