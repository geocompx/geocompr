...
There are two types of datum --- geocentric and local (Figure \@ref(fig:datum-fig)).
...
(ref:datum-fig) Earth-centered and local geodetic datums shown on top of a geoid (in false color and the vertical exaggeration by 10000 scale factor). Image of the geoid is adapted from the work of @essd-11-647-2019.

```{r datum-fig, echo=FALSE, message=FALSE, fig.cap="(ref:datum-fig)", fig.scap="Earth-centered and local geodetic datums on a geoid."}
