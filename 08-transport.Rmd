...
Some models built using software such as [MATSim](http://www.matsim.org/) can effectively capture the dynamics of transport systems using an agent-based modelling (ABM) approach at high spatial and temporal resolution.
