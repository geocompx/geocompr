...
More importantly, official administrative zones seldom relate to where people travel.
...
For the purposes of this chapter an additional stage is needed because the input data is provided at the origin-destination level:
...
This explains why the spatial distribution represented in Figure \@ref(fig:destzones) is relatively uneven, with the most common destination zones concentrated in Bristol city center.
