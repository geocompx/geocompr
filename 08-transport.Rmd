...
ways$osm_lines$highway = gsub("_link", "", x = ways$osm_lines$highway)
ways$osm_lines$highway = gsub("primary|secondary", "road", x = ways$osm_lines$highway)
...
library(tmap)
tmap_mode("view")
qtm(ways$osm_lines, lines.col = "highway", lines.lwd = 3, lines.palette = c("green", "red", "black", "orange")) +
  tm_scale_bar()
