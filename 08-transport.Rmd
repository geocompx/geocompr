...
```{r zones, echo=FALSE, fig.cap="Number of trips (commuters) living and working in the region. The left map shows zone of origin of commute trips; the right map shows zone of destination.", message=FALSE, fig.show='hold', fig.height=9, out.width="50%"}
library(tmap)
tmap_mode("plot")
