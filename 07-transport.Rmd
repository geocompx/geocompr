...
The case study used for this chapter is a diverse city on the west of England, just north of the Welsh capital Cardiff.
As with any case study it is worth taking some time to consider the local geography of the area, e.g. as dispayed in Figure \@ref(fig:bristol).
...
```{r, echo=FALSE, fig.cap="Overview map of the city of Bristol", message=FALSE}
library(tmap)
tmap_mode("view")
