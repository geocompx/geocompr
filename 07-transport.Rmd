...
```{r od, echo=FALSE}
od_top5 %>% 
  knitr::kable(caption = "Sample of the origin-destination data stored in the data frame object the origin-destination dataset. These represent the top 5 most common desire lines between zones in the study area.")
```
...
knitr::include_graphics("figures/cycle-paths-leaflet.png")
```
