...
```{r desire, echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Desire lines representing trip patterns in the Bristol Travel to Work Area. The four black lines represent the data presented in Table 8.1."}
# tmap figure
...
```{r, echo=FALSE, eval=FALSE}
# save output to spDataLarge
setwd("../spDataLarge/")
devtools::use_data(desire_carshort)
```
