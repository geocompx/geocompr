...
It appears that the GLM\index{GLM} (aggregated AUROC\index{AUROC} was `r sp_cv$aggregate(measures = mlr3::msr("classif.auc"))`) is slightly better than the SVM\index{SVM} in this specific case.
