...
It might be a worthwhile exercise to compute the terrain attributes with the help of R-GIS bridges (see Chapter \@(gis)) and extract them to the landslide points (see Exercise section at the end of this chapter).
