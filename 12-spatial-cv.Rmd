...
```{r inner-outer, echo=FALSE, fig.cap="Schematic of hyperparameter tuning and performance estimation levels in CV. [Figure was taken from @schratz_hyperparameter_2019. Permission to reuse it was kindly granted.]", fig.scap="Schematic of hyperparameter tuning."}
