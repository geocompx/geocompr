---
title: "Geocomputation with R - map of the U.S."
...
To do so we can calculate areas of each object:
...
Next, we populate the layout with maps of Alaska and the contiguous 48 states.
Lastly, we add a map of Hawaii to the bottom left of the map and specify its size.
...
In the same time, it is an improvment upon a standard map of United States, which either shows only the contiguous 48 states or largly reduce the size of Hawaii and Alaska.
