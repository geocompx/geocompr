...
In this post we provide provide links to teaching materials we produced for the workshop and provide a some information about the book.
...
One of the most attractive is that geographic data in a appropriate classes can be visualised on a map, the topic of [Chapter 9](http://geocompr.robinlovelace.net/adv-map.html) of the book.
...
To answer that question we used an early data visualisation / infographic created by Alexander von Humboldt, illustrated below.
...
The previously created point representing Budapest, for example, can be visualised using the **tmap** package as follows:
...
The slides forming the basis of the visualisation part of the tutorial can be found here: https://geocompr.github.io/slides/04_viz.html#1
