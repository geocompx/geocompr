...
Our approach differs in one way from the early conception of geocompuation, however:
...
The target audience is broad but we think it will be especially useful to post and under-graduate students, R users wanting to work with spatial data, and GIS users wanting to get to grips with command-line statical modelling software.
