...
An open source book project is being developed with the aim of introducing geocomputation with R. It should provide a solid foundation for developing scripts, functions and applications for geographic data science.
...
For instance, we can represent 'Budapest' (the city where eRum 2018 was held) as a spatial point with the help of the `sf` package as follows:
...
The slides associated with the raster data part of the workshop can be found at https://geocompr.github.io/workshops/erum2018/03_raster.html#1
...
[https://geocompr.github.io/workshops/erum2018/05_rqgis.html#1](https://geocompr.github.io/workshops/erum2018/05_rqgis.html#1)

In the book we additionally demonstrate how to use **RSAGA** and **rgrass7**:

[https://geocompr.robinlovelace.net/gis.html](https://geocompr.robinlovelace.n)et/gis.html
