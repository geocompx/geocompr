...
```{r study-area-mongon, echo = FALSE, fig.cap = "The Mt. Mongón study area (taken from Landsat image: path 9, row 67, acquisition date 09/22/2000; see [earthexplorer.usgs.gov](https://earthexplorer.usgs.gov/))."}
