...
Next, extraction would be performed independly for each group and the results would be combined.
...
<!-- Finally, it could be worthwile to consider using R-GIS bridges. -->
