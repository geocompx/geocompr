...
print(rast_poly_line, vp = viewport(layout.pos.col = 1))
print(plot_transect, vp = viewport(layout.pos.col = 2))
```
...
print(rast_poly_srtm, vp = viewport(layout.pos.col = 1))
print(rast_poly_nlcd, vp = viewport(layout.pos.col = 2))
```
