...
Extract by polygon aslo allows for more complex analysis, such as calculating statistics of continuous raster's values in each polygon (\@ref(fig:polyextr):A) or count number of categories in a categorical raster (\@ref(fig:polyextr):B).
