...
<!-- mention raster::extract(srtm, zion) -->
...
rast_poly_line = tm_shape(srtm) +
  ...
  tm_symbols(size = 5, col = "white") +                                                                     
  tm_text("name") +
  tm_layout(legend.frame = TRUE, legend.position = c("right", "top"))

grid.newpage()
pushViewport(viewport(layout = grid.layout(2, 3, heights = unit(c(0.25, 5), "null"))))
grid.text("A. Point extraction", vp = viewport(layout.pos.row = 1, layout.pos.col = 1))
grid.text("B. Line extraction", vp = viewport(layout.pos.row = 1, layout.pos.col = 2))
# grid.text("C. Polygon extraction", vp = viewport(layout.pos.row = 1, layout.pos.col = 3))
print(rast_poly_point, vp=viewport(layout.pos.col = 1))
print(rast_poly_line, vp=viewport(layout.pos.col = 2))
# print(pz3, vp=viewport(layout.pos.col = 3))
```
