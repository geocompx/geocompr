...
Use the following code to build it:

```{r, eval=FALSE, echo=FALSE}
old_dir = setwd("work-in-progress")
knitr::knit("10-point-pattern.Rmd", output = "10-point-pattern.html")
browseURL("10-point-pattern.html")
setwd(old_dir)
```
