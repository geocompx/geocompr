...
```{r 15-eco-26, echo=FALSE, cache.lazy=FALSE}
autotuner_rf = readRDS("extdata/15-tune.rds")
```

```{r tuning-result, cache.lazy=FALSE}
...
```{r 15-eco-28, cache.lazy=FALSE, eval=FALSE}
...
```{r 15-eco-29, cache.lazy=FALSE, eval=FALSE}
