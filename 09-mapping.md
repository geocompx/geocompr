...
<!--toDo:jn-->
<!-- consider using tmap<>shiny instead of leaflet<>shiny -->
...
<!--toDo:rl-->
<!--add shiny deployment options (even a link!)-->
...
Even if your applications are eventually deployed using different technologies, **shiny** undoubtedly allows web mapping applications to be developed in relatively few lines of code (87 in the case of CycleHireApp).
