...
knitr::kable(sfs_st_cast, 
             ...
             booktabs = TRUE) %>%
  footnote(
    general = paste("Values like (1) represent the number of features;",
                    "NA means the operation is not possible."),
    general = paste("Abbreviations: POI, LIN, POL and GC refer to POINT,",
                    "LINESTRING, POLYGON and GEOMETRYCOLLECTION. The MULTI", 
                    "version of these geometry types is indicated by a", 
                    "preceding M, e.g., MPOI is the acronym for MULTIPOINT."))
```
