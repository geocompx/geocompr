...
pz2 = tm_shape(srtm_cropped) + tm_raster(palette = terrain_colors, title = "Elevation (m)", legend.show = TRUE, style = "cont") + 
  tm_shape(zion) + tm_borders(lwd = 2) + 
  tm_layout(title = "B. Cropped", legend.frame = TRUE, legend.position = c("left", "bottom"))
pz3 = tm_shape(srtm_masked) + tm_raster(palette = terrain_colors, title = "Elevation (m)", legend.show = TRUE, style = "cont") + 
  tm_shape(zion) + tm_borders(lwd = 2) + 
  tm_layout(title = "C. Masked", legend.frame = TRUE, legend.position = c("left", "bottom"))
tmap_arrange(pz1, pz2, pz3, ncol = 3)
```
...
rast_poly_nlcd = tm_shape(nlcd) + tm_raster(palette = landcover_cols, style = "cat", title = "Land cover", legend.show = TRUE) + 
  tm_shape(zion) + tm_borders(lwd = 2) +
