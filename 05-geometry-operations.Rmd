...
```{r, echo=FALSE, eval=FALSE}
zion_transect3 = st_segmentize(zion_transect, dfMaxLength = 1000)
zion_transect3 = st_cast(zion_transect3, "MULTIPOINT")
transect3 = terra::extract(srtm, vect(zion_transect3))
transect3$dist = st_distance(zion_transect3)[, 1]
```
