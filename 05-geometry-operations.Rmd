...
names(sfs_st_cast)[1] = ""
knitr::kable(sfs_st_cast, caption = "Geometry casting on simple feature geometries (see section 2.1) with input type by row and output type by column. Values such as (1) represent the number of features; NA means the operation is not possible.", format = "html") %>%
