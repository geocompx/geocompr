...
```{r pointextr, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Locations of points used for raster extraction (left) and their 1km buffers (right).", out.width="60%", fig.asp=0.57}
