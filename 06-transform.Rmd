...
```{block2 type='rmdnote'}
Two main functions for transformation of simple features coordinates are `sf::st_transfrom()` and `lwgeom::st_transform_proj()`. 
...
Moreover, PROJ.4 parameters can be modifed in most CRS definitions.
