...
```{r, echo=FALSE, fig.cap="Mollweide projection of the world", warning=FALSE}
par_old = par()
par(mar = c(0, 0, 1, 0))
...
```{r, echo=FALSE, fig.cap="Winkel tripel projection of the world", warning=FALSE}
...
```{r, echo=FALSE, fig.cap="Lambert azimuthal equal-area projection of the world centered on longitude and latitude of 0", warning=FALSE}
par_old = par()
par(mar = c(0, 0, 1, 0))
...
```{r, echo=FALSE, fig.cap="Lambert azimuthal equal-area projection of the world centered on New York City", warning=FALSE}
par_old = par()
par(mar = c(0, 0, 1, 0))
