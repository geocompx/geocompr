...
```{r wintirproj, echo=FALSE, fig.cap="Winkel tripel projection of the world", warning=FALSE}
...
For example, the code below gives the map centered on New York City (Figure \@ref(fig:laeaproj2).
...
```{r laeaproj1, echo=FALSE, fig.cap="Lambert azimuthal equal-area projection of the world centered on New York City", warning=FALSE}
par_old = par()
par(mar = c(0, 0, 1, 0))
