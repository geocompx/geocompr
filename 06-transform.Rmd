...
```{r crs-buf, fig.cap="Buffer on data with geographic CRS.", fig.height=6, fig.width=6}
...
```{r crs-buf-proj, fig.cap="Buffer on data with projected CRS.", fig.height=55, fig.width=6}
