...
knitr::kable(dplyr::select(metro_names, city, state), caption = "Result of the reverse geocoding.", booktabs = TRUE)
```
...
knitr::include_graphics("https://user-images.githubusercontent.com/1825120/45922317-d7e66900-bec0-11e8-9bfe-a73ba60a2a7f.png")
```
