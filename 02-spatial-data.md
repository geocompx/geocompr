...
We strongly recommend installing an integrated development environment (IDE) such as [RStudio](https://posit.co/download/rstudio-desktop/#download)\index{RStudio} (recommended for most people) or [VS Code](https://github.com/REditorSupport/vscode-R)\index{VS Code} when writing/running/testing R code.^[
