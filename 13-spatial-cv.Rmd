...
# Most readers will still use Windows. I think it would be important to add the code also for Windows users with a note that the paralleliuation is not reproducible. Also, I would also link to my repo that provides an install guide for Linux Desktop tailored towards R so that users can quickly set up a Virtual Machine at least: https://github.com/pat-s/antergos_setup_guide
