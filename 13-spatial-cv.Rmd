...
Some SVM implementations come with an automated tuning which is usually based on random sampling (see upper row of Figure \ref(\@ref(fig:partitioning))) such as **kernlab**'s `ksvm()`.
