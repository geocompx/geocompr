...
- the decadic logarithm of the catchment area (log m^2^, `log_carea`) representing the amount of water flowing towards a location.
- elevation (m a.s.l., `elev`) as the representation of different altitudinal zones of vegetation and precipitation in the study area.
