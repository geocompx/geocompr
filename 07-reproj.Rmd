...
Both `wkt` and `User Input` elements of the CRS are changed by transforming the object to a projected CRS (only the first 4 lines of the CRS output are shown for brevity):
