...
tm2 = tm_shape(london_buff_projected, bbox = st_bbox(london_buff_s2)) + 
  tm_grid(lwd = 0.2) +
  tm_borders() + 
  tm_shape(uk) +
  tm_borders() +
...
tm3 = tm_shape(london_buff_lonlat, bbox = st_bbox(london_buff_s2)) + 
  tm_graticules(lwd = 0.2) +
  tm_borders() + 
  tm_shape(uk) +
  tm_borders() +
