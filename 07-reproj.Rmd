...
The output of the command shows how the CRS identifier or Spatial Reference System Identifier ([SRID](https://postgis.net/workshops/postgis-intro/projection.html)) works: it is simply a look-up, providing a unique identifier associated with a more complete WTK representation of the CRS.
...
On this point @opengeospatialconsortium_wellknown_2018 is clear, the verbose WKT2 representation takes precedence over the [identifier](https://docs.opengeospatial.org/is/18-010r7/18-010r7.html#37): 
...
As the chunk above shows, WKT strings are exhaustive, detailed, and precise, allowing for unambiguous CRSs storage and transformations.
