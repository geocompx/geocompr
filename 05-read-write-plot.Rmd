...
For example, you can get a list of dataset in a package, `data(package = "spData")`, or load a dataset by specifing the name of a dataset, `data("cycle_hire", package = "spData")`.
