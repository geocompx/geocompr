...
Therefore, we would recommend to use the datatyp that needs the least storing space but still is able to represent all values (check the range of values with the `summary()` function).
