...
file_formats = tibble::tribble(~Name, ~Extension, ~Info, ~Type, ~Model, 
                         ...
                         "GeoTIFF", ".tiff", "GeoTIFF is one of the most popular raster formats. 
Its structure is similar to the regular `.tif` format, however GeoTIFF also stores additional spatial metadata, such as coordinate reference system, spatial extent, `NoData` value, and the data resolution.", "Raster", "Open",
                         ...
                         # "NCDF??"
                         # "HDF??"
                         "SQLite/SpatiaLite", ".sqlite", "SQLite is a stanalone, relational database menagment system. SpatiaLite is an extension to SQLite providing a support for Simple Features.", "Vector and raster", "Open",
                         # "WKT/WKB??",
