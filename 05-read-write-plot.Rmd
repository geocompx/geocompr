...
This chapter is about getting spatial data that onto your computer and then, perhaps after processing it with techniques described in this book, back out to the world.
...
Spatial data comes in a wide variety of file formats, and **sf** is adept at handling them, via the command `st_read`, which uses the GDAL C/C++ library behind the scenes.
