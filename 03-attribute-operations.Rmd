...
And finally, we classify raster operations into four categories using the map algebra scheme [@Tomlin_1990_geographic], and present each of these classes individually by example.
