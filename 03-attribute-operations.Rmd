...
This is typically a  of size 3 x 3 cells (that is one target cell and the eight surrounding neighbors) but can take on any other (not necessarily rectangular) shape as defined by the user.
