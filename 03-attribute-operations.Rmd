...
```{r cont-cate-rasters, echo = FALSE, results = "hide", message = FALSE, fig.width = 7, fig.height = 3, fig.cap = "Raster with numberic values (left) and a raster with categorical values (right)."}
