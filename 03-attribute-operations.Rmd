...
d[, "pop", drop = FALSE]
dplyr::select(d, pop)
# return a vector when selecting a single column, see [Subsetting Operators](http://adv-r.had.co.nz/Subsetting.html#subsetting-operators) chapter of @wickham_advanced_2014 for further details on simplifying and preserving when subsetting. 
d[, "pop"]
pull(d, pop)
```
