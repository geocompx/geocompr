...
Our grain size raster is a good example (Figure @ref(fig:grainsize)) because the different grain sizes are spread in an irregular fashion throughout the raster.

```{r grainsiz, echo = FALSE}
spplot(r_2, col.regions = c("brown","sandybrown", "rosybrown"))
```
