...
Because simple feature object (of class `sf`) are also data frames, you can use all subsetting functions, from base R or packages such as **dplyr** for subsetting them.
