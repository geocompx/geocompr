...
This is a draft version of Chapter 3 in the forethcoming book *Geocomputations with R* hosted at:
...
- This tutorial requires the packages **tidyverse**, **sf** and **raster**:
...
```{block2 type='rmdnote'}
`raster` objects cannot contain values of class 'character'.
...
clay < silt < sand in terms of grain size, so the levels are provided in this order.
```
