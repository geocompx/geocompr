...
This flexibility is illustrated in the command below, which calculates not only the population but also the area and number of countries in each continent, resulting in Table \@ref(tab:continents):
...
```{r 03-attribute-operations-29-2, echo=FALSE}
world_agg4 %>% 
  st_drop_geometry() %>% 
  knitr::kable()
```
