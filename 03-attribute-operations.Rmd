...
Focal operations are basically moving window operations. 
Typically, this window is of size 3 X 3 pixels (that is one target cell and the eight surrounding neighbors) but can take on any other (not necessarily rectangular) shape as defined by the user.
