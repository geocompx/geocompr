...
The intermediary `i_small` is a logical vector that can be used as indeces to subset the seven smallest countries in the `world` by surface area.
...
Key functions for subsetting data frames (including `sf` data frames) are demonstrated below.
