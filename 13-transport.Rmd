...
zones_joined = inner_join(zones_joined, zones_destinations, by = "geo_code") |> 
  st_as_sf()
```
...
desire_rail$geometry = desire_rail$geometry |> sf::st_set_crs("EPSG:4326")
desire_rail$leg_orig = desire_rail$leg_orig |> sf::st_set_crs("EPSG:4326")
desire_rail$leg_via = desire_rail$leg_via |> sf::st_set_crs("EPSG:4326")
desire_rail$leg_dest = desire_rail$leg_dest |> sf::st_set_crs("EPSG:4326")
...
routes_plot_data = rbind(
  desire_lines_short |> transmute(Entity = "Desire lines"),
  routes_short |> transmute(Entity = "Routes")
)
