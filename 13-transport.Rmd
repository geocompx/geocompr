...
From a geographical perspective, routes can be seen as desire lines\index{desire lines} that are no longer straight:
the origin and destination points are the same as in the desire line representation of travel, but the pathway to get from A to B is more complex, typically following ways on the transport network.
