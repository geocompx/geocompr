...
We will demonstrate **sfnetworks** functionality on a subset of the `bristol_ways` object, representing the major road network in the area (roads with a maximum speed of 70 miles per hour).

```{r 13-transport-23}
bristol_ways$geometry_type = st_geometry_type(bristol_ways)
ways_freeway = bristol_ways |> 
  filter(maxspeed == "70 mph", geometry_type == "LINESTRING") 
ways_sfn = sfnetworks::as_sfnetwork(ways_freeway)
class(ways_sfn)
ways_sfn
```
