...
```{r wayssln, fig.cap="Illustration of a small route network, with segment thickness proportional to its betweenness, generated using the igraph package and described in the text.", out.width="60%", fig.scap="Illustration of a small route network.", echo=FALSE}
