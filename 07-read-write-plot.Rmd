...
file_formats = tibble::tribble(~Name, ~Extension, ~Info, ~Type, ~Model, 
                         "ESRI Shapefile", ".shp (the main file)", "Popular format consisting of at least three files. Cannot exceed 2 GB. No support for: mixed types; names > 10 chars; cols > 255.", "Vector", "Partially open",
