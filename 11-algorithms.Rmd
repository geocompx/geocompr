...
Three principles can also help maximise use of your effort when writing code, whether it's a simple script or package that is composed of hundreds of functions:

1. DRY (don't repeat yourself): minimise repetition of code and aim to use fewer lines of code to solve a particular problem. This principle is explained with reference to the use of functions to reduce code repetition in the Functions chapter of R for Data Science [@grolemund_r_2016].
2. [KISS](https://en.wikipedia.org/wiki/KISS_principle) (keep it simple stupid): this principle suggests that 

3. a function should do only one thing but do this really well
   But maybe this is too high-level for the novice?
