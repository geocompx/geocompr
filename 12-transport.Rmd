...
```{r, fig.cap="Illustration of a small route network, with segment thickness proportional to its betweeness, generated using the igraph package and described in the text.", fig.asp=0.8, "Illustration of a small route network."}
g = ways_sln@g
