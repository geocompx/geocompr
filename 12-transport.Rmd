...
```{r 12-transport-18, message=FALSE}
route_carshort = route(l = desire_carshort, route_fun = stplanr::route_osrm)
```
...
```{r routes, warning=FALSE, fig.cap="Routes along which many (300+) short (<5km Euclidean distance) car journeys are made (red) overlaying desire lines representing the same trips (black) and zone centroids (dots).", echo=FALSE, fig.scap="Routes along which many car journeys are made."}
