...
```{r buffs, echo=FALSE, fig.cap="Buffers around the `seine` datasets of 5km (left) and 20km (right). Note the colors, which reflect the fact that 1 buffer is created per geometry feature.", fig.show='hold', out.width="50%"}
plot(seine_buff_5km, key.pos = NULL, main = "5km buffer")
plot(seine, key.pos = NULL, pal = rainbow, add = TRUE)
plot(seine_buff_20km, key.pos = NULL, main = "5km buffer")
