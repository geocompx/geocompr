...
```{r vector-rasterization2, echo=FALSE, fig.cap="Examples of polygon rasterization", warning=FALSE}
library(tmap)
library(grid)
...
# grid.text("C. ", vp = viewport(layout.pos.row = 1, layout.pos.col = 3))
# print(r3po, vp = viewport(layout.pos.row = 2, layout.pos.col = 3))
```
