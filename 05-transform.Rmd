...
Let's try three different approaches to rasterize points - cycle hire locations accross London.
...
In this situation, `rasterize()` expects only three arguments - an input vector data, a raster template, and a value to be transfered to all non-empty cells (Figure \@ref(reproj-vec-geom):B).
