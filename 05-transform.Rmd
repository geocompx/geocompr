...
<!-- add transparency -->
```{r affine-trans, echo=FALSE, fig.cap="Ilustrations of affine transformations: shift, scale, and rotate.", warning=FALSE, eval=FALSE}
library(tmap)
library(grid)
...
This section uses the `elev` object from \@ref(manipulating-raster-objects) (it is also available in the `spData` package).
