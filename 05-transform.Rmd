...
library(rasterVis)
library(ggplot2)
cols1 = c("1" = "brown", "2" = "sandybrown", "3" = "rosybrown")
cols2 = c("clay" = "brown", "silt" = "sandybrown", "sand" = "rosybrown")
...
p2 = ggplot() + 
  geom_sf(data = grain_poly, aes(fill = VALUE)) + 
  scale_x_continuous(expand = c(0,0)) + 
  scale_y_continuous(expand = c(0,0)) +
  theme(line = element_blank(), 
        axis.text = element_blank(),
...
p3 = ggplot() + 
  geom_sf(data = grain_poly2, aes(fill = VALUE)) + 
  scale_x_continuous(expand = c(0,0)) + 
  scale_y_continuous(expand = c(0,0)) +
  theme(line = element_blank(), 
        axis.text = element_blank(),
