...
Transition from mulitpoint to linestring is a common operation used to convert a set of ordered point observations, such as GPS measurements or geotagged media, into a path.
It allows further spatial analysis, including computing a lenght of the path.
Conversion from multipoint or linestring to polygon is used often to calculate an area, for example from a set of GPS measurements taken around a lake or from a corners of a building lot.
