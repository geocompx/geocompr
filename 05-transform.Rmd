...
grid.text("Count", vp = viewport(layout.pos.row = 1, layout.pos.col = 2))
grid.text("Aggregated capacity", vp = viewport(layout.pos.row = 1, layout.pos.col = 3))
print(r1p, vp=viewport(layout.pos.col = 1))
print(r2p, vp=viewport(layout.pos.col = 2))
print(r3p, vp=viewport(layout.pos.col = 3))
```
