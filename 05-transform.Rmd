...
```{r raster-vectorization2, echo=FALSE, fig.cap="Iluustration of vectorization of raster (left) into polygon (center) and polygon aggregation (right).", warning=FALSE}
library(tmap)
library(grid)
