...
```{r seine-simp, echo=FALSE, fig.cap="Comparision of the original data of the Seine, Marne and Yonne rivers and its simplified version using `st_simplify`.", warning=FALSE}
par_old = par()
