...
```{r seine-simp, echo=FALSE, fig.cap="Comparision of the original data of the Seine, Marne and Yonne rivers and its simplified versions using `st_simplify`.", warning=FALSE}
par_old = par()
...
```{r us-simp, echo=FALSE, fig.cap="Comparision of the original data of the contiguous United States and two simplified versions using `st_simplify` and `ms_simplify`.", warning=FALSE}
par_old = par()
