...
plot(nz_raster2)
```
1. Aggregate the raster counting high points in New Zealand created in the previous exercise to halve its geographic resolution (so cells are 6 by 6 km) and plot the result.
