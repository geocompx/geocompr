...
The latter is part of GDAL and therefore requires a vector file, instead of a `sf` object, as an input and rasterization parameters, instead of a `Raster*` template object.
