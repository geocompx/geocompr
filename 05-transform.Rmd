...
<!-- The simplest case is when we want to create a raster  -->
...
grid.text("Points", vp = viewport(layout.pos.row = 1, layout.pos.col = 1))
print(r0p, vp = viewport(layout.pos.row = 2, layout.pos.col = 1))
grid.text("Presence/absensce", vp = viewport(layout.pos.row = 1, layout.pos.col = 2))
...
grid.text("Aggregated capacity", vp = viewport(layout.pos.row = 3, layout.pos.col = 2))
