...
```{block2 type='rmdnote'}
All the grid cells in equal-area projections have the same size (represent the same area).
...
```{r vector-rasterization1, echo=FALSE, fig.cap="", warning=FALSE}
library(tmap)
library(grid)
...
grid.newpage()
pushViewport(viewport(layout = grid.layout(6, 1, heights = unit(rep(c(0.25, 5), 3), "null"))))
grid.text("Presence/absensce", vp = viewport(layout.pos.row = 1, layout.pos.col = 1))
print(r1p, vp = viewport(layout.pos.row = 2))
grid.text("Count", vp = viewport(layout.pos.row = 3, layout.pos.col = 1))
print(r2p, vp = viewport(layout.pos.row = 4))
grid.text("Aggregated capacity", vp = viewport(layout.pos.row = 5, layout.pos.col = 1))
print(r3p, vp = viewport(layout.pos.row = 6))
```
