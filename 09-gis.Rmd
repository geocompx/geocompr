...
In dedicated GIS packages, by contrast, the emphasis tends to be on their graphical user interface (GUI):
you *can* interact with QGIS, SAGA and gvSIG by typing into (dockable) CLIs but 'pointing and clicking' is regretably the norm.
