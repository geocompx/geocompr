...
tm_shape(world_mollweide_gr) + tm_lines(col = "grey") +
  ...
  tm_layout(main.title = "the Mollweide projection", main.title.size = 1.15)
```
...
par(par_old)
# tm_shape(world_wintri_gr) + tm_lines(col = "grey") +
#   tm_shape(world_wintri) + tm_borders(col = "black") +
#   tm_layout(main.title = "the Winkel tripel projection", main.title.size = 1.15)
```
...
tm_shape(world_laea1_g) + tm_lines(col = "grey") +
  ...
  tm_layout(main.title = "the Lambert azimuthal equal-area projection", main.title.size	= 1.15)
```
