...
```{r crs-buf, fig.cap="Buffers around London with a geographic (left) and projected (right) CRS. The grey outline represents the UK coastline.", fig.asp=1, fig.show='hold', out.width="45%", echo=FALSE}
