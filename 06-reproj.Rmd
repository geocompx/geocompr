...
```{r mollproj, echo=FALSE, fig.cap="Mollweide projection of the world.", warning=FALSE, message=FALSE}
library(tmap)
...
res = knitr::knit_child('_06-ex.Rmd', options = list(include = FALSE, eval = FALSE))
cat(res, sep = '\n')
```
