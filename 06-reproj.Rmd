...
An example is provided below, which creates a buffer of one degree around `london` and a buffer of 100km (roughly the same distance at the equator where 1 degree is 111 km) around the `london_geo` object.
