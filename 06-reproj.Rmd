...
```{block2 type="rmdnote"}
The distance between two lines of longitude, called meridians, is around 111 at the equator (execute `geosphere::distGeo(c(0, 0), c(1, 0))` to find the precise distance).
