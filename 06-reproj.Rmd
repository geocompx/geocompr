...
It should have the Lambert Azimuthal Equal Area (`laea`) projection, the WGS84 ellipsoid, the longitude of projection center should be 95 degrees west, the latitude of projection center should equal 60 degrees north, and its units should be in meters.
