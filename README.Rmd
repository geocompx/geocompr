...
[![R build status](https://github.com/Robinlovelace/geocompr/workflows/master/badge.svg)](https://github.com/Robinlovelace/geocompr/actions)
...
The simplest way to get started with Geocomputation with R is in your web browser via Binder.
...
After you have [installed docker](https://www.docker.com/community-edition#/download) and set-it up on [your computer](https://docs.docker.com/install/linux/linux-postinstall/) you can start RStudio Server without a password (see below for code to add a password, essential for public-facing servers):
