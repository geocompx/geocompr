...
This repository hosts the code underlying Geocomputation with R, a book by [Robin Lovelace](http://robinlovelace.net/) and [Jakub Nowosad](https://nowosad.github.io/) and [Jannes Münchow](http://www.geographie.uni-jena.de/en/Muenchow.html).
