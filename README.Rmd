...
- Replacement of code based on the old **mlr** package with code based on the new **mlr3** package, as described in a huge [pull request](https://github.com/Robinlovelace/geocompr/pull/771) and [popular tweet](https://twitter.com/robinlovelace/status/1516139001668898825)
