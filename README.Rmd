...
To ease reproducibility we have set-up a docker image containing all the dependencies needed to reproduce the book.
...
From this point to *build* the book just open the file `index.Rmd` and hit the little `knit` button above the the RStudio script panel (above the `book` text on line 81 illustrated in the image above).
