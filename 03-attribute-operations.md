...
- Also ensure you have installed the **tidyr** package, or **tidyverse** of which it is a part, if you want to run data 'tidying' operations in Section \@ref(vec-attr-creation): 
