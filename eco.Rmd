...
This case study will involve analyzing composition and spatial distribution of the vascular plants on the southern slope of Mt. Mongón, a *lomas* mountain near Casma on the central northern coast of Peru.

```{r study_area_mongon, echo = FALSE, fig.cap = "The Mt. Mongón study area (taken from @muenchow_rqgis:_nodate; Landsat image: path 9, row 67, acquisition date 09/22/2000; @usgs_u.s._2016)."}
...
The sampling coincided with a strong La Niña event that year.
