...
<!-- I guess the code chunk requires much more explanation. What is i? Why -2? Why do you use O instead of just 1? Since it is a large chunk it also would benefit from a few comments -->
```{r}
i = 2:(nrow(poly_mat) - 2)
