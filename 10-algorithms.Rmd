...
<!-- JM: This is not a generic way of finding all triangles, or if it is then this needs to be explained in more detail -->
...
Wouldn't it be easier just to use `st_area`, I mean, nobody says that we cannot use already existing functions, and this way we could spare us the effort of explaining how to compute the area of a triangle, and leave it as an exercise to the reader to do it manually.-->
