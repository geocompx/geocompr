...
<!-- C1 = colMeans(T1[-4, ])  # easier to understand, also I wouldn't put the formula in the text but say that the centroid of a triangle is simply the mean of the x and the y coordinates. -->
```{r}
