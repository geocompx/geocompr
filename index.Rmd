...
<!--The version of the book you are reading now was built on `r Sys.Date()` and was built `r if(is_on_ghactions) "on [Travis](https://travis-ci.org/Robinlovelace/geocompr)" else "locally"`.-->
...
```{r index-3, message=FALSE, eval=is_html, echo=is_html, results='hide'}
