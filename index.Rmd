...
```{r index-3, message=FALSE, eval=is_online}
...
- Letting us know if you've found it useful, e.g. via the [#geocompr hashtag](https://twitter.com/hashtag/geocompr) on Twitter or via [GitHub](https://github.com/Robinlovelace/geocompr/issues/372) (see our [Guestbook here](https://twitter.com/hashtag/geocompr))
