...
url: https\://http://robinlovelace.net/geocompr
---
...
The version of the book you are currently reading was built on `r Sys.Date()` and was built `r if(is_on_travis) "on [Travis](https://travis-ci.org/Robinlovelace/geocompr)" else "locally"`.
