...
<!--
One might wonder whether the framing of 'geocomputation' in the tribute to 21+ years since the Leeds conference bringing 'geocomputation' into being, referred to at the end of the concluding chapter of this book (Chapter \@ref(conclusion)), is not far too narrow [@harris_more_2017]. Doing 'spatial' in R has always been about being broad, seeking to provide and integrate tools from geography, geoinformatics and spatial statistics for anyone interested in joining in: joining in asking interesting questions, contributing fruitful research questions, and writing and improving code. That is: doing 'spatial' in R has always included 'geocomputation' where useful as a component part and source of ideas, not a boundary.
...
Doing 'spatial' in R would never have developed without the engagement of people willing to share what they were creating or adapting. This might include teaching materials, software, research practices (reproducible research, open data), and combinations of these. We've also benefitted greatly from understanding from the developers and maintainers of upstream software, including GDAL, GEOS and PROJ.
