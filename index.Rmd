...
- People who have learned spatial analysis skills using a desktop Geographic Information System (GIS) such as [QGIS](http://qgis.org/en/site/), [ArcMap](http://desktop.arcgis.com/en/arcmap/) and [SAGA](http://www.saga-gis.org/en/index.html) wanting access to the benefits of R --- a powerful (geo)statistical and visualization programming language --- and an interface focussed on the command-line [@sherman_desktop_2008]:

> With the advent of 'modern' GIS software, most people want to point and click their way through life. That’s good, but there is a tremendous amount of flexibility and power waiting for you with the command line. Many times you can do something on the command line in a fraction of the time you
...
R is well-suited to the interactive use required in many geographic data analysi workflows.
R excels in the rapidly growing fields of 'data science', machine learning and (via efficient interfaces to databases and distributed computing systems) Big Data.
