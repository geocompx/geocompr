...
Luckily, `linkGRASS()` of the **link2GI** packages lets one set up the GRASS environment with just one line of code.^[For a more complete description of setting up the GRASS environment read the appendix at the end of this section.]
