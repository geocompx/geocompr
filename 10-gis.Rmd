...
There have also been major developments in enabling open source GIS software to write and execute R scripts from QGIS\index{QGIS} (see https://docs.qgis.org/3.28/en/docs/training_manual/processing/r_intro.html) and GRASS (see https://grasswiki.osgeo.org/wiki/R_statistics/rgrass#R_within_GRASS).
