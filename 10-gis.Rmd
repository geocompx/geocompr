...
Another advantage of dedicated GIS software projects is that they provide access to hundreds of 'geoalgorithms' (computational recipes to solve geographic problems --- see Chapter \@ref(algorithms)), some of which are unavailable from the R command line, except via 'GIS bridges' [@neteler_open_2008].
Such bridges form the basis of this chapter.
