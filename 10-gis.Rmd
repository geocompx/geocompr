...
```{r 09-gis-7, eval=FALSE, echo=FALSE}
...
```{r 09-gis-8, eval=FALSE, echo=FALSE}
...
```{r 09-gis-9, eval=FALSE, message=FALSE, warning=FALSE, echo=FALSE}
...
```{r 09-gis-10, eval=FALSE, echo=FALSE}
...
```{r 09-gis-11, eval=FALSE, echo=FALSE}
...
```{r 09-gis-12, eval=FALSE, echo=FALSE}
...
```{r 09-gis-13, eval=FALSE, echo=FALSE}
...
```{r sliver-fig, echo=FALSE, fig.cap="Sliver polygons colored in blue (left panel). Cleaned polygons (right panel).", fig.scap="Sliver (left panel) and cleaned (right panel) polygons.", echo=FALSE}
