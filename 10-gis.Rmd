...
QGIS provides a unified interface to geoalgorithms from other software, including GDAL\index{GDAL} and, when they are installed, GRASS\index{GRASS}, and SAGA\index{SAGA} [@graser_processing_2015]. 
...
union_arguments = qgis_arguments("native:union")
union_arguments
#> # A tibble: 5 × 6
