...
Our goal in this section is to delineate areas with similar values of NDVI.
We will use the normalized difference vegetation index (NDVI) data for the Mongón study area in Peru from the 22nd of September 2000 (Figure \@ref(fig:sagasegments)).^[Read Section \@ref(local-operations) on details of how to calculate NDVI from a remote sensing image.]
