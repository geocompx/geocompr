...
Since version 3.14 (released in summer 2020), QGIS installs the command line utility 1 for running this abundance of code.
 with 300+ in the standard QGIS installation and 1,000+ 
 (frequently more than 1000, depending on your set-up) outside of the QGIS GUI.
...
```{r enable-providers, eval=has_qgis}
qgis_enable_plugins()
...
```{r uniondata, echo=FALSE, fig.cap="Illustration of two areal units: incongruent (black lines) and aggregating zones (red borders).", eval=has_qgis}
library(tmap)
...
```{r sliver, echo=FALSE, fig.cap="Sliver polygons colored in red (left panel). Cleaned polygons (right panel).", eval=has_qgis}
