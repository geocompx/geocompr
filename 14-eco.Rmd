...
Bagging takes repeated samples from the same input data and averages the predictions.
...
- explain hyperparameters `mtry`, `min.node.size`, `sample.fraction` and `num.trees`
...
tune = tuneParams(learner = lrn_rf, 
                  ...
                  measures = mlr::rmse)
#>...
#> [Tune-x] 49: mtry=3; min.node.size=5; sample.fraction=0.496
#> [Tune-y] 49: rmse.test.rmse=0.5741569; time: 0.0 min
#> [Tune-x] 50: mtry=1; min.node.size=7; sample.fraction=0.488
#> [Tune-y] 50: rmse.test.rmse=0.6437727; time: 0.0 min
#> [Tune] Result: mtry=4; min.node.size=1; sample.fraction=0.748 : rmse.test.rmse=0.5089390
```
...
However, there are at least approaches that help to interpret machine learning learning models (see e.g., [https://mlr-org.github.io/interpretable-machine-learning-iml-and-mlr/](https://mlr-org.github.io/interpretable-machine-learning-iml-and-mlr/)).
