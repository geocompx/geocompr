...
Retrieving terrain attributes (NDVI, dem, slope, catchment area, etc.) -> exemplarily show how to compute catchment area, then advice to follow the steps found in RQGIS paper!!! + Exercise + provide corresponding output rasters!
