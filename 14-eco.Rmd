...
```{r, echo=FALSE, message=FALSE, fig.cap="Study mask (polgyon), location of the sampling sites (black points) and DEM in the background."}
...
```{r xy-nmds, fig.cap="Plotting the first NMDS axis against altitude."}
