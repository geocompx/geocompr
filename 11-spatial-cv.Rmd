...
# data("ta", "lsl", study_mask", package = "spDataLarge")
...
bm_agg = readRDS("extdata/11-sp_conv_cv.rds")
...
sp_cv$aggregate(measures = msr("classif.auc"))
```
...
Hint: You need to specify a non-spatial resampling\index{resampling} strategy.
