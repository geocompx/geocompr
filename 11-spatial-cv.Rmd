...
As a convenience to the reader, the data frame containing the landslide points with the corresponding terrain attributes is also available in the **spDataLarge** package along with the terrain attribute raster stack from which the values were extracted.
