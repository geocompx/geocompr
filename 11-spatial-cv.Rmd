...
The first three rows of `lsl`, rounded to two significant digits, look like this:
...
```{r building-blocks, echo=FALSE, fig.height=4, fig.width=4, fig.cap="Basic building blocks of the mlr package. Source: openml.github.io. Permission to reuse this figure was kindly granted."}
...
```{r inner-outer, echo=FALSE, fig.cap="Schematic of hyperparameter tuning and performance estimation levels in CV. Credit: Patrick Schratz."}
