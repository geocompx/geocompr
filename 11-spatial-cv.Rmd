...
This is a value between 0.5 and 1.0 with 0.5 indicating por model fit and 1.0 indicating a perfect discrimination of the two classes. 
Thus, the higher the AUROC the better our model is at making predictions.
