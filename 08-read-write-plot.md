...
<!-- Geocoding  -->
Several packages for geocoding exist in R; however **tidygeocoder** seems to allow to connect to [the largest number of geocoding services](https://jessecambon.github.io/tidygeocoder/articles/geocoder_services.html)
<!--more-->
This package also allows to perform the opposite process called reverse geocoding used to get a set of information (name, address, etc.) based on a pair of coordinates.
