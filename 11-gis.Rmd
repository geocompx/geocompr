...
## (R)QGIS
QGIS is one of the most popular open-source GIS [Table \@ref(tab:giscomp); @graser_processing:_2015]. Its main advantage lies in the fact that it provides a unified interface to several other open-source GIS.

```{r giscomp, echo = FALSE, message = FALSE}
library(tidyverse)
...
First of all, the GRASS database requires its own directory, and contains a location.
<!-- (Figure \@ref(fig:grass_loc)). (commented to save space (rl)) -->
...
```{r grass_loc, fig.cap="Structure of the GRASS geodatabase system including locations and mapsets Figure was taken from [grass.osgeo.org](https://grass.osgeo.org/grass72/manuals/).", echo=FALSE, eval=FALSE}
