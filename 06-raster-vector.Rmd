...
By default, it is `FALSE` as this operation requires more computations. The `exact_extract()` function always computes the coverage fraction of the polygon in each cell.
```
