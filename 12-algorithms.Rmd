...
- Comment the script sufficiently for others (and your future self) to understand it but not so much that the comments themselves become hard to maintain. At a minimum a good script file should contain information on the purpose of the script and division into chunks, perhaps by appending `----` to section headings, which allows 'folding' of R scripts in RStudio.
