...
The results demonstrate that **sf** is around *`r round(bench_read$time[1] / bench_read$time[2], 0)` times faster* than **rgdal** at reading-in the world countries shapefile.
