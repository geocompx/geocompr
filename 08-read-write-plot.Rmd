...
The following commands show the first three drivers reported from the computer's GDAL installation (results can vary depending on the GDAL version installed) and a summary of their features.
