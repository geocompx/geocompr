...
This tutorial uses two datasets on the spatial distribution and some attributes of cycle hire 'docking stations', one from OpenStreetMap and one from an on-line data feed.^[
...
We convert the datasets to the `Spatial` classes used by the **sp** dataset, as required by point pattern analysis functions used in the chapter.
