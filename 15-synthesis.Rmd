...
Choosing between them is therefore largely a matter of preference, but beware of pitfalls when using **tidyverse** functions to handle spatial data (see the `Spatial data and the tidyverse: pitfalls to avoid` vignette at [geocompr.github.io](https://geocompr.github.io/)).
