...
Many (if not most) methods that have been written about have yet to be fully implemented in code.
Learning about geographic methods and potential applications can therefore be rewarding, before writing any code.
An example of geographic methods that have yet to be fully implemented in R is sampling strategies for scientific applications.
