...
Chapter \@ref(attr) showed how both `nz["Name"]` and `nz %>% select(Name)` can be used to acheive the same result, for example.
...
But there is already excellent material on these things.
