...
It supports *creativity*, encouraging the focus of methods to shift away from the basics
(which are readily available through shared code, avoiding many people 'reinventing the wheel')
and toward applications.
