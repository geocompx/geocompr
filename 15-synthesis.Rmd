...
Although each package covered in this book has a different emphasis, there is inevitably an overlap between them, and there are dozens more packages for geographic data:
...
The choice is a key feature of open source software.
...
Likewise, there are gaps and overlaps in the contents of this book, which are worth considering before we consider the next steps in the next section.
...
- Application to *real-world problems* for the social benefit.
- Building new tools.
