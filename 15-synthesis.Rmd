...
There is already excellent material on these methods, including statistically orientated chapters in @bivand_applied_2013, a book on point pattern analysis by @baddeley_spatial_2015 and a book on Bayesian methods with geographic data by @krainski_advanced_2018 that is available online.
