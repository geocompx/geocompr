...
While commonly needed operators/functions (`[`/`select()` for example) were covered in depth, there are hundreds of other other functions for working with geographic data which have not been mentioned, let alone demonstrated, in the book.
