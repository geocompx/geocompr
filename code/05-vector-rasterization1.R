...
r1p = tm_shape(ch_raster1) + tm_raster(legend.show = TRUE, title = "Values: ") + tm_layout(main.title = "B. Presence/absensce", main.title.size = 1, legend.position = c("right", "bottom"))
