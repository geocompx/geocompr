...
## ----02-spatial-data-10, eval=FALSE--------------------------------------
#> library(sp)
#> world_sp = as(world, Class = "Spatial")
#> # sp functions ...

## ----02-spatial-data-11, eval=FALSE--------------------------------------
...
## ----02-spatial-data-12, warning=FALSE-----------------------------------
...
## ----02-spatial-data-13, echo=FALSE, eval=FALSE--------------------------
#> # aim: show main
#> plot(world$geom, main = "sf plot() method")

## ----02-spatial-data-14, eval=FALSE--------------------------------------
...
## ----02-spatial-data-34, eval=FALSE, echo=FALSE--------------------------
...
## ----02-spatial-data-35, message=FALSE-----------------------------------
raster_filepath = system.file("raster/srtm.tif", package = "spDataLarge")
new_raster = raster(raster_filepath)

## ----02-spatial-data-36, eval=FALSE--------------------------------------
#> new_raster
#> #> class       : RasterLayer
...
## ----02-spatial-data-50, message=FALSE, results='hide'-------------------
...
## ----02-spatial-data-60, warning=FALSE, message=FALSE--------------------
