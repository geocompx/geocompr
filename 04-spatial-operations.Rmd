...
Following code adds one row and two columns to each side of the raster while setting all new values to an elevation of 1000 meters.
...
The default value of the `value` parameter is `NA`.
