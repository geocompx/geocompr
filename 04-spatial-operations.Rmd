...
```{r spatial-join, echo=FALSE, fig.cap="Illustration of a spatial join: the names of the source world object are added to random points.", fig.asp=1.2, warning=FALSE}
