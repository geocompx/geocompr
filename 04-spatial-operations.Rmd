...
```{r spatial-join, echo=FALSE, fig.cap="Illustration of a spatial join. A new attribute variable is added to random points (left) from a source object representing countries (middle) resulting the data represented in the final panel (right).", fig.asp=0.5, warning=FALSE, message=FALSE, out.width="100%"}
