...
```{r 04-spatial-operations-8, echo=FALSE, fig.cap="Topological relations between vector geometries", fig.show='hold', out.width="33%", message=FALSE, fig.width=3, fig.height=3}
