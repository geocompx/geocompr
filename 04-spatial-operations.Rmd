...
Various *topological relations* or *operators* can be used for spatial subsetting, as described in section \@ref(topological-relations).
Topological relations are closely related to subsetting, explaining why we cover this topic before covering other spatial operations, starting with spatial joining and aggregation, from section \@ref(spatial-joining-and-aggregation) onwards.
