...
All spatial objects are related through space, and distance calculations can be used to explore the strength of this relationship. This is covered in Section \@ref(distance-relations).
