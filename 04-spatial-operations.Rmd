...
To illustrate the difference between subsetting and clipping spatial data, we will generate points that cover the bounding box of the circles `x` and `y` in Figure \@ref(fig:venn-clip).
