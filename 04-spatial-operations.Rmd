...
In general terms, spatial subsetting can be seen simply as the spatial equivalent of *attribute subsetting*, covered in section \@ref(attribute-subsetting), which used methods from base R and **tidyverse**.
