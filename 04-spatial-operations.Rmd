...
To demonstrate how DE-9IM strings work, let's take a look at the first geometry pair in Figure \@ref(fig:relations)

```{r, echo=FALSE, warning=FALSE}
p1_2 = st_as_sf(c(p1, p3))
p1_2_intersection_interior = st_as_sf(st_intersection(p1, p3))
p1_2_intersection_interior$domain_a = "Interior"
p1_2_intersection_interior$domain_b = "Interior"
p1_2_intersection_interior$Object = "Intersection"
p1_2_intersection = st_intersection(st_cast(p1, "LINESTRING"), p3)
...
b9sf$domain_a = rep(rep(domains, 3), each = 2)
b9sf$domain_b = rep(rep(domains, each = 3), each = 2)
b9sf = rbind(b9sf, p1_2_intersection_interior)
...
ggplot(b9sf) +
  ...
  scale_fill_manual(values = c("red", "lightblue", "yellow")) +
