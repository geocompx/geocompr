...
Common spatial subsetting, aggregation and joining tasks have non-spatial equivalents, covered in the previous chapter in sections \@ref(attribute-subsetting), \@ref(attribute-data-aggregation) and \@ref(attribute-data-joining) respectively.
