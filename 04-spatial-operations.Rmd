...
```{r relation-objects, echo=FALSE, fig.cap="Points (p 1 to 4), line and polygon objects arranged to demonstrate spatial relations.", fig.asp=1, out.width="40%"}
par(pty = "s")
...
m2 = mask(elev, rmask, maskvalue = TRUE) # with mask()
...
e2 = raster(nrows = 6, ncols = 6, res = 0.5, 
           xmn = -1.5, xmx = 1.5, ymn = -1.5, ymx = 1.5,
           vals = 1:36)
