...
<!-- find a better ueberleitung-->
Suppose we would like to add airborne or remotely sensed information to all observations within our study area.
...
### Aligning rasters
When merging or performing map algebra on rasters, their resolution, projection and origin/extent has to match.
...
Finally, if you want to align many (possbibly hundreds or thousands of) images stored on disk, you might want to checkout the `gdalUtils::align_rasters()` function.
