...
```{r relation-objects, echo=FALSE, fig.cap="Points (point df 1 to 3), line and polygon objects arranged to illustrate topological relations.", fig.asp=1, out.width="50%", fig.scap="Demonstration of topological relations."}
par(pty = "s")
