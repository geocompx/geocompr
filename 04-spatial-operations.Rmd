...
the spatial aggregation operation assumes that all `r round(world$pop[world$name_long == "Algeria"] / 1e6)` Algerian citizens reside in the tiny southerly tip that is within the circular buffer.
