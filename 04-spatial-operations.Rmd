...
```{r globe, echo=FALSE, fig.cap="Hypothetical subsetting scenario: select all countries which intersect with a circle of 2000 km in radius around planet Earth. Figure created with the **[globe](https://cran.r-project.org/package=globe)** package."}
