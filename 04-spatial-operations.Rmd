...
```{r 04-spatial-operations-6, out.lines=6}
...
```{r areal-example, echo=FALSE, fig.cap="Illustration of congruent (left) and incongruent (right) areal units with respect to larger aggregating zones (translucent ted borders).", fig.asp=0.33, fig.scap="Illustration of congruent and incongruent areal units."}
