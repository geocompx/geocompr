...
data, as illustrated in the code chunk below:^[**dplyr** discards row names by design.
...
```{r}
clip = raster(nrow = 3, ncol = 3, res = 0.3, xmn = -0.45, xmx = 0.45, 
...
### Merge, mosaic rasters

Figure \@ref(fig:mosaic-intersect))


```{r mosaic-intersect, echo = FALSE, fig.cap = "Merging two input rasters and retrieving their intersection."}
knitr::include_graphics("figures/04_mosaic_intersect.png")
```
