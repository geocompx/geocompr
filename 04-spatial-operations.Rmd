...
qtm(buff_agg, fill = pal[4], bbox = bb) +
  tm_shape(world_buff) +
...
the spatial aggregation operation assumes that all `r round(world$pop[world$name_long == "Sudan"] / 1e6)` Sudanese people reside in the tiny southerly tip that is within the circular buffer.
