...
This shows that there are `r sum(lengths(sel) > 0)` points in the target object `cycle_hire` within the threshold distance.
...
two overlapping circles with a center point 1 unit away from each other and radius of 1:
