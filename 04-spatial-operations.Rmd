...
plot(st_geometry(nz), col = "white", bgc = "lightblue", main = "High points in New Zealand")
plot(st_geometry(nz_height), add = TRUE, pch = 2, col = "red")
par(mar=c(0, 0, 1, 0))
plot(st_geometry(nz), col = "white", bgc = "lightblue", main = "High points in Canterbury")
plot(st_geometry(canterbury), col = "grey", add = TRUE)
plot(st_geometry(canterbury_height), add = TRUE, pch = 2, col = "red")
par(par_old)
```
...
```{r spatial-join, echo=FALSE, fig.cap="Illustration of a spatial join: the names of the source world object are added to random points.", fig.asp=0.4, warning=FALSE}
source("code/04-spatial-join.R")
tmap_arrange(jm1, jm2, jm3, nrow = 1)
```
