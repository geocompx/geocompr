...
In section \@ref(attribute-subsetting) we saw how rows could be subsetted based on their index (e.g. `world[1:6,]` to select the first 6 countries) or some criteria returning a `logical` vector of `TRUE`s and `FALSE`s (e.g.  `world[world$area_km2 < 10000,]`).
