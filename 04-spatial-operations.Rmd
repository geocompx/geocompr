...
*Map algebra* cover a range of operations that modify raster cell values, with or without reference to surrounding cell values, is is vital for many applications.
...
\index{map algebra}
The term 'map algebra' was coined in the late 1970s to describe a "set of conventions, capabilities, and techniques" for the analysis of geographic data [@tomlin_1994_map].


Map algebra operations tend to be fast.
