...
```{r globe, echo=FALSE, fig.cap="Hypothetical subsetting scenario: select all countries which intersect with a circle of 10 degrees in radius around planet Earth."}
