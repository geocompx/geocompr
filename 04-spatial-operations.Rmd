...
```{r nz-subset, echo=FALSE, warning=FALSE, fig.cap="Illustration of spatial subsetting with red triangles representing 101 high points in New Zealand, clustered near the central Canterbuy region. The right-hand map contains points generated using spatial subsetting."}
...
knitr::include_graphics("figures/cycle-hire-leaflet.png")
```
...
```{r spatial-aggregation, echo=FALSE, fig.cap="Average height of high points across the regions of New Zealand."}
library(tmap)
