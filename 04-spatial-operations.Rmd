...
```{r 04-spatial-operations-8, echo=FALSE, fig.cap="Topological relations between vector geometries", fig.show='hold', out.width="33%", message=FALSE, fig.width=3}
...
p5 = st_sfc(st_polygon(list(rbind(c(0.6, 0.1), c(0.7, 0.5), c(1, 0.5), c(0.6, 0.1)))))
p6 = st_sfc(st_polygon(list(rbind(c(0, 0.2), c(0, 1), c(0.9, 1), c(0, 0.2)))))
de_9im(p1, p2)
de_9im(p1, p3)
de_9im(p1, p4)
de_9im(p4, p1)
