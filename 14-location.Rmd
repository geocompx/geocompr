...
metro_names = sf::st_centroid(metros) |>
  tmaptools::rev_geocode_OSM(as.data.frame = TRUE) |>
  dplyr::select(city, town, state)
metro_names = mutate(metro_names, city = ifelse(is.na(city), town, city))
```
...
Use `dplyr::as_tibble()` to convert it into a tibble\index{tibble}.
