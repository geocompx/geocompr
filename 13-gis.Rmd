...
execGRASS(cmd = "v.clean", 
          parameters = list(input = "streets", output = "streets_clean",
                            tool = "break"), flags = c("overwrite")) 
# find out why doGRASS is not working...
# doGRASS("v.clean",  flags = c("overwrite"), input = "streets", output = "streets_clean",
#         tool = "break")
# prepare network by connecting points to roads / changes roads
execGRASS(cmd = "v.net", 
          parameters = list(input = "streets_clean", output = "streets_points_con", 
                            points = "points", operation = "connect",
                            threshold = 1000), flags = c("overwrite", "c"))
doGRASS(cmd = "v.net", input = "streets_clean", output = "street_points",
          points = "points", operation = "connect", threshold = 1000,
          flags = c("overwrite", "c"))

# run tsp
execGRASS(cmd = "v.net.salesman", 
          parameters = list(input = "streets_points_con", output = "final_route",
                            center_cats = "1-50"), flags = c("overwrite"))
# doGRASS(cmd = "v.net.salesman", input = "street_points", 
#         output = "final_route", center_cats = "1-50", flags = "overwrite")

route <- readVECT("final_route")
points <- readVECT("points")
