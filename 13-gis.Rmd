...
The interface is not the only difference however: there are many algorithms within dedicated GIS software that R can access through 'bridges': add-on packages that enable R to access GIS functionality developed for dedicated GIS software.^[
