...
Usually, `rsaga.env()` will detect SAGA automatically. However, I have 'hidden' SAGA in my OSGEO4W-installation (-> RSAGA feature request), which is why I have to indicate the corresponding path:
