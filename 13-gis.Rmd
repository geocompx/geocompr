...
```{r}
library("RSAGA")
saga_env <- rsaga.env(path = "C:/OSGeo4W64/apps/saga")
```
...
You can find a more detailed example for statistical geocomputation in the RSAGA vignette `vignette("RSAGA-landslides")`.
cite citation("RSAGA").
