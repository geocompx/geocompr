...
E2. In the geometric algorithms section we calculated that the area and geographic centroid of the polygon represented by `poly_mat` was `r sum(A)` and `r round(c(weighted.mean(C[, 1], A), weighted.mean(C[, 2], A)), 1)`, respectively.
...
```{r 11-ex-e3}
x_coords = c(10, 5, 0, 0, 12, 20, 10)
y_coords = c(0, 5, 0, 10, 20, 15, 0)
