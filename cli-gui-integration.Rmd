...
## (R)QGIS
The main advantage of using QGIS is that it provides a unified interface to many open-source GIS.
First and foremost this means that you have access to GDAL/OGR, GRASS and SAGA through QGIS but also to other third-party providers such as TauDEM, Orfeo Toolbox and Lastools (tools for LiDAR data) [@graser_processing:_2015]. 
