...
This is because the `shop` column contains `NA` values, which are omitted when rasterizing vector objects.
...
mapview(result > 10, map.type = "OpenStreetMap", legend = TRUE)
```
zoom into Berlin 
