...
```{r census-stack, echo = FALSE, fig.cap = "Gridded German census data of 2011. See Table \\@ref(tab:census-desc) for a description of the classes. For reproducing this figure, see `code/08-location-jm.R`."}
...
```{r metro-areas, echo = FALSE, fig.width = 1, fig.height = 1, fig.cap = "The aggregated population raster (resolution: 20 km) with the identified metropolitan areas (golden polygons) and the corresponding names. For reproducing this figure, see `code/08-location-jm.R`."}
...
```{r bikeshop-berlin, echo = FALSE, eval = TRUE, fig.cap = "Suitable areas (i.e. raster cells with a score > 9) in accordance with our hypothetical survey for bike stores in Berlin. For reproducing this figure, see `code/08-location-jm.R`."}
library(leaflet)
library(sp)
