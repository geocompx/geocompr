...
Maybe data at a better resolution changes and improves the output (see exercises).
...
That is, if there already is a bike shop in the vicinity of the chosen location, one has to distribute possible customers (or sales potential) between the competitors [@wieland_market_2017].
- We need to make sure to find suitable and affordable real estate (accessible, parking spots, frequency of passers-by, big windows, friendly staff, etc.).
