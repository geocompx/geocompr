...
Similarly, humans tend to congregate certain places, creating economic niches (and high land prices) in certain places.
The main task of geomarketing is to find out where such 'optimal locations' are for a range of services, based on available data.
