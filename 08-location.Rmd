...
```{r census-stack, echo = FALSE, fig.cap = "Gridded German census data of 2011. See Table 8.1 for a description of the classes."}
...
```{r bikeshop-berlin, echo=FALSE, fig.cap="Suitable areas (raster cells with a score > 9) in accordance with our hypothetical survey for bike stores in Berlin."}
# library(leaflet)
# library(sp)
...
knitr::include_graphics("figures/location-leaflet.png")
```
