...
The final raster stack consists of four layers: inhabitants, mean age, portion of women and household size.
...
Instead we let the algorithm sleep between 1.2 and 3.4 seconds before accessing the reverse geocoding API again.
...
Overall, we are satisfied with the metropolitan names (Munich, Nuremberg, Stuttgart, Frankfurt, Hamburg, Berlin, Leipzig) bar one exception, namely Velbert.
