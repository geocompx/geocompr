...
We will use the NDVI data for the Mongón study area in Peru from the 22nd of September 2000 (Figure \@ref(fig:sagasegments)) and a seeded region growing algorithm from SAGA GIS to achive the goal.^[Read Section \@ref(local-operations) on details of how to calculate NDVI from a remote sensing image.]
...
The seeded region growing algorithm works in two main steps [@bohner_image_2006]. 
...
The second SAGA GIS tool we use is `seeded_region_growing`.
<!--toDo:jn-->
<!-- explain the tool -->
